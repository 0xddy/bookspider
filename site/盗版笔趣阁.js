...
var category = [
    {title: '玄幻书架', id: 1, page: {start: 1, end: 572}},
    {title: '修真小说', id: 2, page: {start: 1, end: 195}},
    {title: '都市小说', id: 3, page: {start: 1, end: 463}},
    {title: '穿越小说', id: 4, page: {start: 1, end: 152}},
    {title: '网游小说', id: 5, page: {start: 1, end: 150}},
    {title: '科幻小说', id: 6, page: {start: 1, end: 219}}
];
...
function getPageUrl(cateId, currentPage) {
    return getBaseUrl() + '/fenlei/' + cateId + '_' + currentPage + '.html';
}
